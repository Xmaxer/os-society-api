class User < ApplicationRecord
  ...
  validates :username, length: {in: 1..20, too_long: Constants::Errors::USER_USERNAME_TOO_LONG_ERROR[:message], too_short: Constants::Errors::USER_USERNAME_TOO_SHORT_ERROR[:message]}, presence: {message: Constants::Errors::USER_USERNAME_NOT_PRESENT_ERROR[:message]}, format: {with: /\A([a-zA-Z0-9\-_]+\s)*[a-zA-Z0-9\-_]+\Z/i, message: Constants::Errors::USER_USERNAME_NOT_VALID_ERROR[:message]}
